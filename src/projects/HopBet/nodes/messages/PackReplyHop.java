...
public class PackReplyHop extends Message {
	...
	public PackReplyHop(int hops, int path, int senderID, int sinkID, int sendTo, ArrayList<Integer> sendToNodes , double sBet) {
		this.hops = hops;
		this.path = path;
	...
	public Message clone() {
		...
		return new PackReplyHop(this.hops, this.path, this.senderID, this.sinkID, this.sendTo, this.sendToNodes, this.sBet);
	}
