package projects.Ett.models.connectivityModels;
...
public class EttConnectivityHelper extends ConnectivityModelHelper {
private double squareRadius;
	...
	public EttConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public EttConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
