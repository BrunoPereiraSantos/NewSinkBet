...
public class PackHelloHop extends Message {
	...
	public PackHelloHop(int hops, int path, int senderID, int sinkID) {
		this.hops = hops;
		this.path = path;
	...
	public Message clone() {
		...
		return  new PackHelloHop(this.hops, this.path, this.senderID, this.sinkID);
	}
