package projects.BetHop.models.connectivityModels;
...
public class BetHopConnectivityHelper extends ConnectivityModelHelper {
private double squareRadius;
	...
	public BetHopConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public BetHopConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
