package projects.Routing.models.connectivityModels;
...
public class ConnectModel extends ConnectivityModelHelper {
	...
	public ConnectModel(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public ConnectModel() throws CorruptConfigurationEntryException {
		if(! initialized) {
