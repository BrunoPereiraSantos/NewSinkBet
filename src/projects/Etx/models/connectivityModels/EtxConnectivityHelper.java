package projects.Etx.models.connectivityModels;
...
public class EtxConnectivityHelper extends ConnectivityModelHelper {
private double squareRadius;
	...
	public EtxConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public EtxConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
