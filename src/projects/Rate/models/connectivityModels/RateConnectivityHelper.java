package projects.Rate.models.connectivityModels;
...
public class RateConnectivityHelper extends ConnectivityModelHelper {
	...
	public RateConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public RateConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
