package projects.RateBet.models.connectivityModels;
...
public class MyConnectivityHelper extends ConnectivityModelHelper {
	...
	public MyConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public MyConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
