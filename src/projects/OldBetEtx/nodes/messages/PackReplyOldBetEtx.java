...
public class PackReplyOldBetEtx extends Message {
	 ...
	 * @param fwdID
	 */
	public PackReplyOldBetEtx(int hops, int path, int senderID, int sinkID,
	...
	public Message clone() {
		...
		return new PackReplyOldBetEtx(this.hops, this.path, this.senderID, this.sinkID, this.sendTo, this.sendToNodes, this.ETX, this.sBet, this.fwdID);
	}
