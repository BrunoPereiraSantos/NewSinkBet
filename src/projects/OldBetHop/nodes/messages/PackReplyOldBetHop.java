package projects.OldBetHop.nodes.messages;

import java.util.ArrayList;

import sinalgo.nodes.messages.Message;

public class PackReplyOldBetHop extends Message {
	...
	public PackReplyOldBetHop(){}
		
	public PackReplyOldBetHop(int hops, int path, int senderID, int sinkID, int sendTo, ArrayList<Integer> sendToNodes , double sBet) {
		this.hops = hops;
		this.path = path;
	...
	public Message clone() {
		...
		return new PackReplyOldBetHop(this.hops, this.path, this.senderID, this.sinkID, this.sendTo, this.sendToNodes, this.sBet);
	}
