...
public class PackHelloOldBetHop extends Message {
	...
	public PackHelloOldBetHop(){}
	
	public PackHelloOldBetHop(int hops, int path, int senderID, int sinkID) {
		this.hops = hops;
		this.path = path;
	...
	public Message clone() {
		...
		return  new PackHelloOldBetHop(this.hops, this.path, this.senderID, this.sinkID);
	}
