package projects.BetEtt.models.connectivityModels;
...
public class BetEttConnectivityHelper extends ConnectivityModelHelper {
private double squareRadius;
	...
	public BetEttConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public BetEttConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
