package projects.BetEtx.models.connectivityModels;
...
public class BetEtxConnectivityHelper extends ConnectivityModelHelper {
private double squareRadius;
	...
	public BetEtxConnectivityHelper(double rMax) {
		squareRadius = rMax * rMax;
	}
	 ...
	 */
	public BetEtxConnectivityHelper() throws CorruptConfigurationEntryException {
		if(! initialized) {
